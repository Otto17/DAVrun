...
либо если попытаться открыть его в другой копии скомпилированной программы Admin DAVrun с другим ключом "AES-256" или "IV".
...
4) Обфусцируем программу "Admin DAVrun" после компиляции, что бы хоть как то защитить от "мамкиного хакера" при декомпиляции ключ шифрования и Вектор инициализации.
...
Запускаем обфускатор и выбираем скомпилированный файл "Admin DAVrun", ставим галочки "Encode String with Base64" и "INT Confusion", жмём кнопку "Protect", готово. Обфусцированный файл появится в папке с программой "NetShield Protector", а исходный файл удаляем.
