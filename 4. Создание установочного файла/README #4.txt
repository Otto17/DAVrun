...
4) Открываем скрипт "Script_Setup_DAVrun.iss" в Inno Setup, включаем "ENABLE", если хотите сразу создать зашифрованный конфиг файл после установки и жмём для создания установочного файла Ctrl+F9 или Build -> Compile;
