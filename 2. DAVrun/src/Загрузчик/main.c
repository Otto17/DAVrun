...
const char *hardcoded_password = "b7raXw79WK7MW87nHrRKNkKIinT0AMNr";    // Жёстко закодированный пароль (ОБЯЗАТЕЛЬНО СГЕНЕРИРОВАТЬ СВОЙ ЧЕРЕЗ ПРОГРАММУ "Keygen_Pepper_Hard_Passwd.exe") из папки "Генератор ключей"
const char *pepper = "noqxkoeq390Mv1NB";                                // Поперчить пароль             (ОБЯЗАТЕЛЬНО СГЕНЕРИРОВАТЬ СВОЙ ЧЕРЕЗ ПРОГРАММУ "Keygen_Pepper_Hard_Passwd.exe") из папки "Генератор ключей"
#endif
