...
Новый проект **RiReMQ**, является полностью переосмысленным и более удобным в использовании и настройке, чем DAVrun.

  
**RiReMQ** \- Автоматическая развёртка программ, самораспаковывающихся архивов, выполнения удалённых команд и получение информации о компьютерах с обратной связью по MQTT на большое количество компьютеров не связанных одной сетью.  
